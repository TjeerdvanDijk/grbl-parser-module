import settingsMap from './data/gcode_map.json' assert {type: 'json'};
import gcodeMap from './data/gcode_map.json' assert {type: 'json'};

export {settingsMap, gcodeMap};

export const supportedVersions = ['Grbl 1.1e', 'Grbl 1.1f'];
